...
#   c) node1 mines 32 blocks, so now node 0 has 60001tsc, node 1 has 4250tsc, node2 has none.
#   d) node0 sends 601 tsc to node2, in two transactions (301 tsc, then 300 tsc).
