...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TelSerraCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "TelSerraCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TelSerraCoin features */
        {"telserracoin", "masternode", &masternode, true, true, false},
        {"telserracoin", "listmasternodes", &listmasternodes, true, true, false},
        {"telserracoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"telserracoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"telserracoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"telserracoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"telserracoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"telserracoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"telserracoin", "masternodedebug", &masternodedebug, true, true, false},
        {"telserracoin", "startmasternode", &startmasternode, true, true, false},
        {"telserracoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"telserracoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"telserracoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"telserracoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"telserracoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"telserracoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"telserracoin", "mnbudget", &mnbudget, true, true, false},
        {"telserracoin", "preparebudget", &preparebudget, true, true, false},
        {"telserracoin", "submitbudget", &submitbudget, true, true, false},
        {"telserracoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"telserracoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"telserracoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"telserracoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"telserracoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"telserracoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"telserracoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"telserracoin", "checkbudgets", &checkbudgets, true, true, false},
        {"telserracoin", "mnsync", &mnsync, true, true, false},
        {"telserracoin", "spork", &spork, true, true, false},
        {"telserracoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getztscseed", &getztscseed, false, false, true},
        {"zerocoin", "setztscseed", &setztscseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdztsc", &searchdztsc, false, false, true},
        {"zerocoin", "dztscstate", &dztscstate, false, false, true}
...
{
    return "> telserracoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7751/\n";
}
