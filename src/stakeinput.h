...
#ifndef TelSerraCoin_STAKEINPUT_H
#define TelSerraCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZTSC() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zTSCStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked ztsc, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZTSC() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZTSC() override { return false; }
};


#endif //TelSerraCoin_STAKEINPUT_H
