...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TelSerraCoin Core telserracoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  telserracoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded telserracoin transaction") + "\n" +
                               "  telserracoin-tx [options] -create [commands]   " + _("Create hex-encoded telserracoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded telserracoin transaction
