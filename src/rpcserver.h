...
/**
 * TelSerraCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setztscseed(const UniValue& params, bool fHelp);
extern UniValue getztscseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdztsc(const UniValue& params, bool fHelp);
extern UniValue dztscstate(const UniValue& params, bool fHelp);
