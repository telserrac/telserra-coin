...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TelSerraCoin Core"),
     ...
     * override -datadir in the telserracoin.conf file in the default data directory
     * (to be consistent with telserracoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
