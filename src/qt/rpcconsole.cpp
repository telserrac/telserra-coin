                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTSCPathCustom = GetArg("-ztscbackuppath", "");
    ...
    if(!strzTSCPathCustom.empty()) {
        ui->wallet_customztscbackuppath->setText(QString::fromStdString(strzTSCPathCustom));
        ui->wallet_customztscbackuppath_label->setVisible(true);
        ui->wallet_customztscbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTSCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TelSerraCoin RPC console.") + "<br>" +
