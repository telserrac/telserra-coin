...
/* TelSerraCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TelSerraCoin"
#define QAPP_ORG_DOMAIN "telserracoin.org"
#define QAPP_APP_NAME_DEFAULT "TelSerraCoin-Qt"
#define QAPP_APP_NAME_TESTNET "TelSerraCoin-Qt-testnet"
