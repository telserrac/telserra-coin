...
/** Utility functions used by the TelSerraCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TelSerraCoin addresses in monospace font
...
// Parse "telserracoin:" URI into recipient object, return true on successful parsing
