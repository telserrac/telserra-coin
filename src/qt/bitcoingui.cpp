                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TelSerraCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TelSerraCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and telserracoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TelSerraCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about TelSerraCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TelSerraCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TelSerraCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TelSerraCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a TelSerraCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TelSerraCoin Core help message to get a list with possible TelSerraCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TelSerraCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TelSerraCoin network", "", count));
}
...
{
    QString strTitle = tr("TelSerraCoin Core"); // default title
