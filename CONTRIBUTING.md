Contributing to TelSerraCoin Core
============================

The TelSerraCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TelSerraCoin Core project, and is not to be
confused with overall TelSerraCoin Network Protocol consensus changes.

Whether a pull request is merged into TelSerraCoin Core rests with the project merge
...
Patches that change TelSerraCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the TelSerraCoin consensus, it must have been
...
The project leader is the release manager for each TelSerraCoin Core release.
