...
This mechanism has been integrated into Bitcore-Node-TelSerraCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TelSerraCoin-Project/insight-api-telserracoin#web-socket-api](https://github.com/TelSerraCoin-Project/insight-api-telserracoin#web-socket-api) 
* API: [https://github.com/TelSerraCoin-Project/insight-api-telserracoin#swifttx-transactions](https://github.com/TelSerraCoin-Project/insight-api-telserracoin#swifttx-transactions) 
...
By default, the TelSerraCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TelSerraCoin Core daemon:
