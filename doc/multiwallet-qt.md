...
In order to support loading of multiple wallets in telserracoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is telserracoin.cpp.
...
Changes to telserracoin.cpp
----------------------
telserracoin.cpp is the entry point into telserracoin-qt, and as such, will require some minor modifications to provide hooks for
